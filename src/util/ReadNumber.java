...
public class ReadNumber {
	...
	public static String numberToString(String number) {
		BigDecimal numberTotal = new BigDecimal(number.substring(0, number.length() - 2));
		String sNumber = numberTotal.toString();
		// Tao mot bien tra ve
		String sReturn = "";
		...
		// xu ly lan cuoi voi 220 000 tá»· 000 000 000 000 000 HUTTV ADDED 3 OCT
	...
	public static String Read(String sNumber, int iPo) {
		...
		// xu ly lan cuoi voi 220 000 tá»· 000 000 000 000 000
		if(sNumber.length()>12)
		{
			// tren gia tri can xu ly, kiem tra xem don vi TY co = 000 khong
